<x-layout>
    <section class="purple-finger">
        <div class="container mx-auto grid lg:grid-cols-2 p-8 lg:pt-20">
                <div class="flex flex-col gap-10">
                    <x-heading class="lg:w-[90%] md:w-full w-[80%] text-lightBlue">Program pre  dospelých
                    </x-heading>
                    <h2 class="text-xl md:text-2xl lg:text-4xl text-[#424242] font-semibold lg:w-[90%] md:w-full w-[80%]">Využi, čo ti ide prirodzene, aby sa ti viac darilo a rob, čo ťa naozaj baví.</h2>
                        <x-paragraph>
                        Tvoj život je výsledkom tvojich rozhodnutí. Predstav si, aké by bolo mať úplnú istotu o svojich schopnostiach, osobnosti a cieľoch.
                        </x-paragraph>
                        <x-paragraph>
                        Nastal čas naplno využiť svoje silné stránky, pretože úspech prichádza vďaka tomu, čo nám ide najlepšie.
                        </x-paragraph>
                    <div>
    ...
    <section>
        <div class="mx-auto container p-8">
            <x-heading class="text-[#424242] py-20">Zisti s nami aké máš <span class="text-lightBlue">schopnosti, osobnosť,<br>
            čo ťa motivuje a napĺňa.</span>
            </x-heading>
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1">
                <div class="flex flex-col gap-4">
                    ...
                    <x-check>
                        Testovanie prebieha online
                    </x-check>
                    <x-check>
                        Testujeme schopnosti, osobnosť a dlhodobé záujmy
                    </x-check>
                    <x-check>
                        6 hodín práce psychológa, kariérneho poradcu a kouča
                    </x-check>
                    <div class="pt-10 lg:flex hidden"><x-button-primary class="px-8">Pripojiť sa na kurz</x-button-primary></div>
                </div>
                <div class="flex flex-col gap-4">
                    <x-check>
                        Podrobné vysvetlenie výsledkov na stretnutí
                    </x-check>
                    <x-check>
                        Odporúčania od psychológa pre tvoj ďalší rozvoj
                    </x-check>
                    <x-check>
    ...
    <section>
        <div class="mx-auto container p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-0 gap-10 lg:py-20 py-10">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <h2 class="text-xl font-semibold text-lightBlue">Netrápime ťa vyčerpávajúcimi rozhovormi.                        </h2> 
                    </div>
                    <div class="flex flex-row gap-4">
                        <img src="images/svgBlue.svg" alt="">      
                        <h2 class="text-xl font-semibold text-lightBlue">Používame spoľahlivé psychologické a kariérne testy.
                        </h2> 
                    </div>
                    <div class="flex flex-row gap-4">
                        <img src="images/svgPurple.svg" alt="">      
                        <h2 class="text-xl font-semibold text-lightBlue">Celým programom ťa sprevádza poradca. 
                        </h2> 
                    </div>
                </div>
            </div>
            <x-paragraph>
            To pre to, aby tvoj profil aj odporúčania povolaní boli spoľahlivé a čo najpresnejšie.
            Vďaka výsledkom ti povieme aj <span class="text-lightBlue">ako manažuješ, komunikuješ, čo ťa motivuje</span> a <span class="text-lightPurple">ako zlepšíš, čo ti robí problémy.</span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 py-20">
                <div class="wrapper">
                    <div class="single-card">
                        ...
                        <div class="back flex justify-center items-center p-10">
                            <x-paragraph>
                                <strong>Spojíme sa na</strong> <span class="text-lightPurple">online úvodnú konzultáciu</span> a <strong>ujasníme si čo riešiš.</strong>
                                Testy nastavíme tak, aby si dostal odpovede na to, čo ťa zaujíma.
                            </x-paragraph>
                        </div>
                    </div>
                </div>
                <div class="wrapper">
                    <div class="single-card">
                        ...
                        <div class="back flex justify-center items-center p-10">
                            <x-paragraph>
                            <strong>Vyplníš online test osobnosti a dlhodobých záujmov</strong> Ak súhlasíš požiadame tvojich blízkych vyplniť <strong>dotazník o tebe</strong>. Všetky informácie vyhodnotí psychológ. 
                            </x-paragraph>
                        </div>
                    </div>
                </div>
                <div class="wrapper">
                    <div class="single-card">
                        ...
                        <div class="back flex justify-center items-center p-10">
                            <x-paragraph>
                            <strong>Stretneme sa</strong> (osobne v BA alebo online) a <strong>zrozumiteľne ti vysvetlíme, čo presne tvoje výsledky znamenajú</strong>. Zameriavame sa na <strong>tvoje silné stránky  a ako ich najlepšie využiješ</strong>. Poradíme ti ohľadom kariéry alebo dôležitého životného rozhodnutia.
                            </x-paragraph>
                        </div>
                    </div>
                </div>
            ...
            2 roky testovania dospelých nám pomohli nastaviť <span class="text-lightBlue">Program pre dospelých</span> tak, 
            aby ti dal istotu, že smeruješ správne.
            <span class="text-lightPurple">Zisti s nami, čo si o sebe vždy chcel vedieť!</span>
            </x-paragraph>
        </div>
    </section>
