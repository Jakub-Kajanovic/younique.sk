    ...
    <form method="POST" action="{{ route('blog.store') }}" enctype="multipart/form-data">
        ...
        <div class="max-w-3xl mx-auto">
            <div class="mt-4">
                ...
                <input type="text" id="title" name="title" class="shadow appearance-none border rounded w-full py-2 px-3 text-lightGray leading-tight focus:outline-none focus:shadow-outline"/>
                @error('title')
            ...
            <textarea name="content" id="myeditorinstance">Sem napíš o čom bude tvoj blog!</textarea>
            <div class="mt-4">
